...
export const __testing = { state, endGame, restartGame, registerRanking, startNewGame, startDrag, dropDie, cancelDrag, playSound, setSfxEnabled, preloadAudio };
